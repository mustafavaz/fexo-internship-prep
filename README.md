...
TypeScript fundamentals practice ahead of a backend internship at **Fexobit** (Node.js + RxJS, TypeScript, PostgreSQL, Redis, RabbitMQ).

Coming from a Java backend background — five progressively harder TypeScript projects, all trading/exchange-themed, building toward RxJS.
